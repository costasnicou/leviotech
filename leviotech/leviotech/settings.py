"""
Django settings for leviotech project.
...
SECRET_KEY = 'django-insecure-u47^f$=adg=t%uhgj+as##qprc!6p6sd()w=rrl^))fwg%@z4r'
...
WSGI_APPLICATION = 'leviotech.wsgi.application'
